...
import math.Vec4;
import math.function.FunctionR1Vec4;
import scenegraph.Channel;

public class FunctionR1Vec4Controller extends AbstController {
	/*
	 * Time-parameterized function (R1 -> R4))
	 */
	private FunctionR1Vec4 func;

	/**
	 * channel to the object, which shall be changed over time, the object
	 * itself must be of type Vec4.
	 */
	 ...
	 */
	public FunctionR1Vec4Controller( RepeatType loopMode,  
			float localMinTime, 
			float localMaxTime, 
	 ...
	 * @param func The function which controls the channel
	 */
	public FunctionR1Vec4Controller(RepeatType loopMode, Channel channel, FunctionR1Vec4 func ) {
	...
	public boolean update(float time) {
		...
		// the evaluated value.
		((Vec4) channel.getData()).set(func.eval(ctrlTime));
		return true;
	}
	 ...
	 */
	public void setFunc(FunctionR1Vec4 func) {
		this.func = func;
	}
}
