...
import scenegraph.util.BVHClip.Pose;
...
public class Aufgabe12_3
{
	 ...
	 */
	public Aufgabe12_3(int width, int height)
	{
		...
		//crouching clip
		BVHClip clip_crouching = Loader.loadBVH ("gerri_walking_chair.bvh");
	...
	public static void main(String[] args) {
		...
		Aufgabe12_3 demo   = new Aufgabe12_3( width, height );
		demo.gameLoop();
	}
