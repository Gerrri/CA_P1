...
public class TestFrog {
	...
	public TestFrog(int width, int height) {
		...
		EulerRotationController kontroller_eu = new EulerRotationController("linear Rotation",frog1.getChannel("Rotation"));
		controllers.add(kontroller_eu);
		
		//Kontroller erstellen Quaternion
		QuatRotationController kontroller_quat = new QuatRotationController("spheric Rotation", frog2.getChannel("Rotation"));
