...
public class TestBezierKubisch_fliegen
{
	/**
	 ...
	 */
	public TestBezierKubisch_fliegen(int width, int height)
	{
		...
		camera = new PerspectiveCamera(0, 10, 10);
		...
		// s1
			...
			vec_points1[0] = new Vec3(-3, 0.01f, 2);
			vec_points1[1] = new Vec3(-3f, 4f, -5f);
			vec_points1[2] = new Vec3(5f, 4f, -1f);
			vec_points1[3] = new Vec3(5f, 3f, -4);
		...
		world = VisualHelp.makePath(world, FunctionR1Vec3Util.connect(s1_prime));
		
		
		controllers.add( new FunctionR1Vec3Controller(AbstController.RepeatType.CLAMP, bird.getChannel("Translation"), FunctionR1Vec3Util.connect(s1_prime)));
	...
	public static void main(String[] args) {
		...
		TestBezierKubisch_fliegen demo   = new TestBezierKubisch_fliegen( width, height );
		demo.gameLoop();
	}
